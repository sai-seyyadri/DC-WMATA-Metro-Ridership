...
index = ['0', '1', '2', '3', '4']
df_dec4 = pd.DataFrame(data_dec4, index=index)

df_dec4.to_csv('december_4.csv', index=True, index_label="Indexes", header=True)

print("Total ridership data for December 4, 2024, has been saved in 'december_4.csv'.")
