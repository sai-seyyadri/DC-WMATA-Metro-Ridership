...
### Evening riders
df = pd.read_csv("Data/WMATA_Ridership_Summary.xlsx - March_23_2024.csv")
...
index = ['0', '1', '2', '3', '4']
df_march23 = pd.DataFrame(data_march23, index=index)

df_march23.to_csv('march_23.csv', index=True, index_label="Indexes", 
                 header=True)