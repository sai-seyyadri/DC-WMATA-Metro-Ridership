...
### Evening riders
df = pd.read_csv("Data/WMATA_Ridership_Summary.xlsx - December_21_2024.csv")
...
index = ['0', '1', '2', '3', '4']
df_dec21 = pd.DataFrame(data_dec21, index=index)

df_dec21.to_csv('december_21.csv', index=True, index_label="Indexes", header=True)

print("Total ridership data for December 21, 2024, has been saved in 'december_21.csv'.")
