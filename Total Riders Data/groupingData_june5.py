...
df = pd.read_csv("Data/WMATA_Ridership_Summary.xlsx - June_05_2024.csv")
...
index = ['0', '1', '2', '3', '4']
df_june5 = pd.DataFrame(data_june5, index=index)

df_june5.to_csv('june_5.csv', index=True, index_label="Indexes", header=True)

print("Total ridership data for June 5, 2024, has been saved in 'june_5.csv'.")
