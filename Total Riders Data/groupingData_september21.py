...
### Evening riders
df = pd.read_csv("Data/WMATA_Ridership_Summary.xlsx - September_21_2024.csv")
...
index = ['0', '1', '2', '3', '4']
df_sept21 = pd.DataFrame(data_sept21, index=index)

df_sept21.to_csv('september_21.csv', index=True, index_label="Indexes", 
                 header=True)