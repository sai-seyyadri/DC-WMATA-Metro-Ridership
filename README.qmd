---
title: "Info Challenge 2025 Challenge"
format: gfm
editor: visual
---
...
We matched the provided dates by the xlsx with the coresponding events that took place in Washington DC. This would also to determine whether there is an external factor that would incentivise people to use use the metro.
...
-   **Events Happening on the provided Days:**
    ...
    -   (March 20 - April) (spring break comeback for students) (NavyYard Ball park), March time frame
    ...
    -   Sep 21 --\> (NavyYard Ball park), March time frame (Weekdays: higher progression of commuting- Peek pm, Midday and Am)
...
-   \(1\) We decided to split the data into the 5 time categories: Late Night (12am-Close), Evening (7pm-12am), PM Peak (3pm-7pm), Midday (9:30am-3pm), AM Peak (Open-9:30am). Then by time category, we plan to the sum the amount of people that took the metro.

-   \(2\) Additionally, we grouped the data by station name and took of the average of all of the 5 different time periods per day. Then merge the data frames together by Weekdays, Weekends and AllDays.
...
-   finding reliable websites that contain important data such as events occurring in Washington DC during the given days and a spatial map of Washington DC and its surrounding area
-   deepen our understanding with certain libraries in Python and R.

**Sources we used:**

-   <https://infinitylimocar.com/upcoming-events-2024-in-washington-dc/> <https://washington.org/find-dc-listings/events>
