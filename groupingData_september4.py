...
### Evening riders
df = pd.read_csv("Data/WMATA_Ridership_Summary.xlsx - September_4_2024.csv")
...
index = ['0', '1', '2', '3', '4']
df_sept4 = pd.DataFrame(data_sept4, index=index)

df_sept4.to_csv('september_4.csv', index=True, index_label="Indexes", 
                 header=True)